...
<body>
    ...
    <table border="1">
        ...
        <tr>
            <td>{{ $i++ }}</td>
            <td>{{ $transferData->transfer->receipt_number}}</td>
            <td>{{ $transferData->item_data->product->name }} {{ $transferData->item_data->attribute1_value }} {{ $transferData->item_data->attribute2_value }} {{ $transferData->item_data->attribute3_value }}</td>
